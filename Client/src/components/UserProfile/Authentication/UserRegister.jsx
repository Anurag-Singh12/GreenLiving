...
const UserRegister = ({updateReloadState}) => {
  ...
  return (
    ...
    <div className='flex h-[90vh] w-full shadow-lg items-center justify-center flex-col'>
        <form onSubmit={handleSubmit} className='flex bg-linear-to-r from-slate-100 to-slate-200 w-[40%] p-8 shadow-xl border rounded-xl  items-center flex-col' action="">
